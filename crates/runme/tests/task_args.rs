//! Integration tests for #[runme::task] argument forms.
//!
...
#[runme::task(desc = "A zero-arg task")]
...
#[runme::task(desc = "A task with simple args")]
...
#[runme::task(desc = "A task with a single string arg")]
...
#[runme::task(desc = "A task with optional and vec args")]
...
#[runme::task(desc = "A task with underscored param names")]
...
#[runme::task(desc = "A task with a parser struct")]
